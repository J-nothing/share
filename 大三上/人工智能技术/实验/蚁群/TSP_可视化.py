...
best_path =  [1, 15, 18, 17, 19, 2, 25, 20, 21, 23, 22, 24, 32, 33, 26, 8, 30, 3, 29, 31, 4, 5, 14, 27, 6, 28, 16, 12, 13, 7, 0, 11, 10, 9, 1]


total_distance = 155.49
...
# 图形设置
plt.title('34城市TSP - 蚁群算法最优路径', fontsize=16, pad=20)
plt.xlabel('经度')
plt.ylabel('纬度')
...
output_path = r"E:\NKUer\2025~2026第一学期\人工智能技术\实验\蚁群\tsp_result.png"
plt.savefig(output_path, dpi=300, bbox_inches='tight')
print("图像已保存为: tsp_route.png")
